...
model {
  ...
  log_weights[1] = log(0.2) + normal_lpdf(x | -7, 1);
  log_weights[2] = log(0.2) + normal_lpdf(x | -5, 1);
  log_weights[3] = log(0.1) + normal_lpdf(x | -5, 1);
  log_weights[4] = log(0.3) + normal_lpdf(x | 6, 1);
  log_weights[5] = log(0.2) + normal_lpdf(x | 8, 1);
