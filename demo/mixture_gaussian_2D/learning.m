...
policy_plot_2D(policy1, "Step 1 Policy", plot_log_pdf);
axis square;
...
policy_plot_2D(policy3, "Step 1500 Policy", plot_log_pdf);
axis square;
...
policy_plot_2D(policy140, "Step 70000 Policy", plot_log_pdf);
axis square;
