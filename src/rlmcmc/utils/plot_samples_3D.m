function plot_samples_3D(sample, proposed_sample, log_target_pdf, lb, ub)
...
for i = 1:size(sample, 1)
    create_mean_drift_3D(sample(i,:), proposed_sample(i,:), log_target_pdf, lb, ub)
end
...
function create_mean_drift_3D(sample, proposed_sample, log_target_pdf, lb, ub)
