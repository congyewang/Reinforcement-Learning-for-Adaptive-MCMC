function plot_demo_2D_3(xlims, n_break1, n_break2)
...
policy_plot_sample_2D(policy1, plot_log_pdf, black_color, nits, lb, ub, sample_path);
...
policy_plot_sample_2D(policy3, plot_log_pdf, red_color, nits, lb, ub, sample_path);
...
policy_plot_sample_2D(policy140, plot_log_pdf, blue_color, nits, lb, ub, sample_path);
