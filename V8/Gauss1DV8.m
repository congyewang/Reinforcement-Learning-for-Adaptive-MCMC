classdef Gauss1DV8 < rl.env.MATLABEnvironment
    ...
    methods
        ...
        function [Observation, Reward, IsDone, Info] = step(this, Action)
            ...
            LogProposalCurrent = this.logProposalPdf(x_n, x_n_plus_1 + phi_x_n_plus_1, this.sigma);
            LogProposalProposed = this.logProposalPdf(x_n_plus_1, x_n + phi_x_n, this.sigma);
            ...
            if log(rand()) < LogAlpha
                ...
                AcceptedMean = x_n_plus_1 + phi_x_n_plus_1;
            else
                AcceptedStatus = false;
                AcceptedSample = x_n;
                AcceptedMean = x_n + phi_x_n;
            end
